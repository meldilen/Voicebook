...
function AchievementsPage() {
  ...
  // Моковые данные (вместо запроса к API)
  const mockAchievements = [
    { id: 1, title: "Первый шаг", description: "Сделайте первую запись", category: "voice", unlocked: true },
    { id: 2, title: "Путь к стабильности", description: "5 записей подряд", category: "regularity", unlocked: false },
    { id: 3, title: "Разнообразие тем", description: "Запишите о разных эмоциях", category: "variety", unlocked: true },
    { id: 4, title: "Самоанализ", description: "Проанализируйте себя в записи", category: "reflection", unlocked: false },
    { id: 5, title: "Светлые мысли", description: "Запишите позитивную историю", category: "positivity", unlocked: true },
    { id: 6, title: "Глубина", description: "Запись с глубоким смыслом", category: "analysis", unlocked: false },
    { id: 7, title: "Общение", description: "Поделитесь записью с другом", category: "social", unlocked: false },
  ];
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setAchievementsData(mockAchievements);
      setLoading(false);
    }, 800); // полсекунды "загрузки"
