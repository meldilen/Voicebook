      ...
      <div className="audio-recorder-container">
        {permission === "denied" && (
          <div className="notification-banner warning">
            ...
            <div className="banner-content">
              <div className="banner-title">{t("audioRecorder.microphoneBlocked.title")}</div>
        ...
        >
          <button
            ...
            aria-label={isRecording ? t("audioRecorder.ariaLabels.stopRecording") : t("audioRecorder.ariaLabels.startRecording")}
            disabled={
              permission === "denied" ||
              isActionInProgress ||
        ...
        {isRecording && showControls && (
          <div className="recording-controls-below">
            ...
            <button
              ...
              onClick={togglePause}
              aria-label={isPaused ? t("audioRecorder.ariaLabels.resumeRecording") : t("audioRecorder.ariaLabels.pauseRecording")}
            >
        ...
        {audioBlob && !isRecording && !showDeleteConfirm && (
          <div className="post-recording-actions">
            <div className="action-buttons-container">
              ...
              >
                <FaTrash />
                <span className="button-label">{t("audioRecorder.buttons.delete")}</span>
              </button>
              <button
              ...
              >
                <FaCheck />
                <span className="button-label">{t("audioRecorder.buttons.save")}</span>
              </button>
            </div>
          </div>
        )}
