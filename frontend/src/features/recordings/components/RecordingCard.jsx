  ...
  return (
    <div className="recording-card">
      ...
      {result.insights ? (
        <>
            ...
            (content) => (
              <div className="insights-grid">
                <div className="insight-item">
                  ...
                  <p>{capitalizeFirst(content) || t("recordingCard.noData.pattern")}</p>
                </div>
          ...
          {renderInsightSection(
            ...
            (support) => (
              <div className="physical-response">
                <p>{capitalizeFirst(support) || t("recordingCard.noData.support")}</p>
              </div>
            )
          )}
          ...
          {renderInsightSection(
            ...
            (reaction) => (
              <div className="physical-response">
                <p>{capitalizeFirst(reaction) || t("recordingCard.noData.physicalReaction")}</p>
              </div>
            )
          )}
      ...
      <div className="card-footer">
        <p className="record-date">{t("recordingCard.recorded")}: {formattedDate}</p>
      </div>
