...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/totals/{userID}/recalculate/{date}": {
            "post": {
        ...
        "/users/me": {
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Profile fields to update (any or all)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
